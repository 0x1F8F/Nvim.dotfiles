...
ins_left {
  ...
  color = function()
    ...
    return { fg = mode_color[vim.fn.mode()], bg = colors.mantle }
  end,
  padding = { right = 1 },
}
...
ins_left {
  ...
  color = { fg = colors.mantle, bg = colors_macchiato.base }, -- Sets highlighting of component
...
ins_right {
  ...
  symbols = { added = '󰙴 ', modified = ' ', removed = '󰆳 ' },
  diff_color = {
...
ins_right {
  ...
  color = { fg = colors.crust, bg = colors.base },
